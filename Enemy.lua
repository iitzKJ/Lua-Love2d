    ...
    elseif dice == 2 then
        _x = _radius * 4
        _y = math.random(_radius, love.graphics.getHeight()) -- hides the spawn location
    elseif dice == 3 then
        _x = math.random(_radius, love.graphics.getWidth())
        ...
        return {
            ...
            checkTouched = function(self, player_x, player_y, cursor_radius) -- Collision detection basically i hate maths
